...
class LLMProvider(ABC):
    ...
    @abstractmethod
    async def complete(self, system_prompt: str, messages: List[Dict[str, str]], **kwargs) -> str:
        """
    ...
    @abstractmethod
    async def stream(self, system_prompt: str, messages: List[Dict[str, str]], **kwargs):
        """
