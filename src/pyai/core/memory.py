...
class ConversationMemory(Memory):
    ...
    def add_message(
        self, role: str, content: str, metadata: Optional[Dict[str, Any]] = None, **kwargs
    ) -> None:
...
class BufferMemory(Memory):
    ...
    def search(self, query: str, limit: int = 5) -> List[Message]:
        query_lower = query.lower()
        return [msg for msg in self._messages if query_lower in msg.content.lower()][:limit]
...
class VectorMemory(Memory):
    ...
    def search(self, query: str, limit: int = 5) -> List[Message]:
        ...
        if not self.embedding_provider or not self._embeddings:
            ...
            return [m for m in self._messages if query.lower() in m.content.lower()][:limit]
