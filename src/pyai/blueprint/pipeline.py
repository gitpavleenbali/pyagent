...
class Pipeline:
    ...
    async def run(self, data: Any) -> Any:
        ...
        for stage in self.stages:
            ...
            for middleware in self._middleware:
                current_data = await self._apply_middleware(middleware, stage, current_data)
    ...
    async def _apply_middleware(self, middleware: Callable, stage: PipelineStage, data: Any) -> Any:
...
class AgentPipeline(Pipeline):
    ...
    def add_skill(self, name: str, skill: Any, **skill_params) -> "AgentPipeline":
