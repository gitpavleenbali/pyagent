...
class TestToolDiscovery:
    ...
    def test_import_discovery(self):
        from pyagent.tools import ToolDiscovery
    ...
    def test_discover_tools_function(self):
        from pyagent.tools import discover_tools
        assert callable(discover_tools)
    
    def test_load_tools_from_directory(self):
        from pyagent.tools import load_tools_from_directory
...
class TestToolWatcher:
    ...
    def test_import_watcher(self):
        from pyagent.tools import ToolWatcher
...
class TestSessionCheckpoint:
    ...
    def test_import_checkpoint(self):
        from pyagent.sessions import SessionCheckpoint
...
class TestAudio:
    ...
    def test_audio_from_base64(self):
        from pyagent.multimodal import Audio, AudioFormat
...
class TestMultimodalContent:
    ...
    def test_import_content(self):
        from pyagent.multimodal import MultimodalContent
...
class TestA2AProtocol:
    ...
    def test_a2a_task_creation(self):
        from pyagent.a2a import A2ATask
    ...
    def test_a2a_response(self):
        from pyagent.a2a import A2AResponse, TaskStatus
...
class TestA2AServer:
    ...
    def test_endpoint_creation(self):
        from pyagent.a2a import A2AEndpoint, A2ATask, A2AResponse
...
class TestA2AClient:
    ...
    def test_import_remote_agent(self):
        from pyagent.a2a import RemoteAgent
...
class TestAgentRegistry:
    ...
    def test_import_registry(self):
        from pyagent.a2a import AgentRegistry
...
class TestAudioStream:
    ...
    def test_import_audio_stream(self):
        from pyagent.voice import AudioStream
...
class TestMainExports:
    ...
    def test_export_tools(self):
        import pyagent
        assert hasattr(pyagent, 'tools')
        assert hasattr(pyagent, 'Tool')
        assert hasattr(pyagent, 'ToolDiscovery')
    
    def test_export_context_cache(self):
        import pyagent
        assert hasattr(pyagent, 'ContextCache')
        assert hasattr(pyagent, 'cache_context')
    
    def test_export_multimodal(self):
        import pyagent
        assert hasattr(pyagent, 'multimodal')
        assert hasattr(pyagent, 'Image')
        assert hasattr(pyagent, 'Audio')
        assert hasattr(pyagent, 'Video')
    
    def test_export_vectordb(self):
        import pyagent
        assert hasattr(pyagent, 'vectordb')
        assert hasattr(pyagent, 'VectorStore')
        assert hasattr(pyagent, 'MemoryVectorStore')
    
    def test_export_a2a(self):
        import pyagent
        assert hasattr(pyagent, 'a2a')
        assert hasattr(pyagent, 'A2AServer')
        assert hasattr(pyagent, 'A2AClient')
    
    def test_export_devui(self):
        import pyagent
        assert hasattr(pyagent, 'devui')
        assert hasattr(pyagent, 'DevUI')
        assert hasattr(pyagent, 'launch_ui')
    
    def test_export_voice(self):
        import pyagent
        assert hasattr(pyagent, 'voice')
        assert hasattr(pyagent, 'VoiceSession')
        assert hasattr(pyagent, 'AudioStream')
